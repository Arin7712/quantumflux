  ...
  return (
    ...
    <div className=' flex md:flex-row flex-col justify-between items-start '>
      ...
      <div className='flex flex-col items-start md:w-[45%] w-full pt-10 md:pt-0'>
        ...
        <p className="md:ml-[7.5rem] pt-4 pr-0 md:pr-[8rem] w-[100%] md:w-[70%] ">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries,</p>
      </div>
    </div>
